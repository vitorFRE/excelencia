			...
			<Container>
				<div className='flex pt-4 flex-row justify-between items-center'>
					<div className='flex gap-2 items-center'>
						<BsTelephoneFill className='text-primary' size={24} />{' '}
						<p className='font-semibold'>{phoneNumber}</p>
					</div>

					<div className='flex items-center gap-4'>
						<BsFacebook size={24} className='text-primary cursor-pointer' />
						<BsLinkedin size={24} className='text-primary cursor-pointer' />
						<BsInstagram size={24} className=' text-primary cursor-pointer' />
					</div>
				</div>
			</Container>
		</div>
